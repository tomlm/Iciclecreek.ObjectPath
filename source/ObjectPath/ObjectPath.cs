...
namespace ObjectUtils
{
    ...
    /// <summary>
    /// Helper methods for working with dynamic json objects using property string paths like "x.y[3]"
    /// </summary>
    public static class ObjectPath
    {
        ...
        /// <summary>
        /// HasValue() - returns true if subpath has a value on the object
        /// </summary>
        ...
        /// </summary>
        /// <exception cref="KeyNotFoundException">Throws exception if path is not valid</exception>
        ...
        /// <summary>
        /// Get the value for a path relative to an object, or specified default value if it doesn't exist
        /// </summary>
        /// <typeparam name="T">type to return.</typeparam>
        /// <param name="obj">object to start with.</param>
        /// <param name="path">path to evaluate.</param>
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        private static void SetObjectSegment(object obj, object segment, object value, bool json = true)
        {
            ...
            if (prop != null)
            {
                SetTargetProperty(obj, prop, val);
            }
        }
        ...
        public static void SetTargetProperty(object targetObject, PropertyInfo? targetProperty, object value)
        {
